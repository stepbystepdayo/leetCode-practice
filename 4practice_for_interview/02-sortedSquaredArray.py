'''Write a function that takes in a non-empty array of integrs that are sorted in ascending order and returns a new array of the same length with the squares of yhe original integers also sorted in ascending order'''
